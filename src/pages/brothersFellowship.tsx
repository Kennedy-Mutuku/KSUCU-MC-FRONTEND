                    ...
                    <div className="flex-1 space-y-8">
                        <div className="prose prose-lg max-w-none text-[#000000]">
                            <p className="text-lg leading-relaxed">
                                Brothers' fellowships deal with matters concerning gents. The fellowship handles topics that benefit members academically, spiritually, financially, socially, and physically.
                            </p>
                        </div>
